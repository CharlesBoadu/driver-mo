...
function ResetPasswordPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password - Driver Mo Insurance</title>
        <meta
          name="description"
          content="reset the password to your Driver Mo account."
        />
      </Helmet>
            ...
            <Card className="bg-white/80 backdrop-blur-lg border-gray-200 shadow-2xl shadow-orange-200/50">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-gray-600 text-lg">
                  Reset the password to your driver mo account
                </CardDescription>
              </CardHeader>
                ...
                >
                  ...
                  <TabsContent value="phone_password">
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="client-password">New Password</Label>
                        <div className="relative">
