...
import { Shield, Car, Users, ArrowRight, CheckCircle, MapPin, Mail, Phone } from 'lucide-react';
...
function HomePage() {
  ...
  const features = [
    {
      ...
      description: "Get protected in seconds with our embedded insurance solutions"
    },
    {
      icon: Car,
      title: "No Hidden Charges",
      description: "Same price, same quantity while protecting your journey, life and family."
    },
    {
      icon: Users,
      title: "Simple Onboarding",
      description: "Register your vehicle and get started in just a few minutes"
    }
  ];
  ...
  const partners = [
    { name: "Goodwill Insurance Brokers", logo: "https://horizons-cdn.hostinger.com/2508d51d-3209-478c-8611-2e55f445eb2e/390e8daef08b94a494fdb8ef72305d0c.png" },
    { name: "miLife Insurance", logo: "https://horizons-cdn.hostinger.com/2508d51d-3209-478c-8611-2e55f445eb2e/d2dac2c46dee9ad969ebacb578c5ffa6.png" },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Driver Mo provides embedded insurance solutions for drivers. Get instant coverage and thank you driver benefits." />
      </Helmet>
      ...
      <div className="min-h-screen overflow-hidden bg-gray-50">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Simple, embedded insurance solutions that recognize and protect drivers across the nation.
                    </p>
                </motion.div>
                <motion.div
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We're revolutionizing insurance for drivers with embedded solutions that work seamlessly with your daily routine.
              </p>
            </motion.div>
        ...
        <section id="contact" className="py-20 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">Have questions? We're here to help.</p>
            <div className="grid md:grid-cols-3 gap-8 text-left">
              <div className="flex items-start gap-4">
                <MapPin className="w-8 h-8 text-orange-500 mt-1" />
                <div>
                  <h3 className="font-bold text-lg">Location</h3>
                  <p className="text-gray-600">1st Floor, Virtue Trust Buidling, Opp. Ghana Trade Fair</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@brokers.goodwillinsure.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
        ...
        <section className="py-20 px-4 bg-gray-50">
          <div className="max-w-6xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-gray-700 mb-2">Powered by Goodwill Insurance Brokers</h3>
            <p className="text-gray-500 mb-8">Underwritten by miLife Insurance & in partnership with leading OMCs</p>
            <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8">
              {partners.map((partner, index) => (
                ...
                >
                  <img  className="h-16 object-contain grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all" alt={partner.name} src={partner.logo} />
                </motion.div>
              ))}
            </div>
          </div>
